...
const DockSettings = GObject.registerClass({
    ...
    _init(extensionPreferences) {
        ...
        this._settings = extensionPreferences.getSettings(
            'org.gnome.shell.extensions.dash-to-dock2');
    ...
    _bindSettings() {
        ...
        // Click animation style combo
        this._builder.get_object('click_animation_combo').set_active(this._settings.get_enum('click-animation-style'));
        this._builder.get_object('click_animation_combo').connect('changed', widget => {
